! function(t, e) {
    ...
    let r;
    const l = ["a[href]", "area[href]", 'input:not([disabled]):not([type="hidden"]):not([aria-hidden])', "select:not([disabled]):not([aria-hidden])", "textarea:not([disabled]):not([aria-hidden])", "button:not([disabled]):not([aria-hidden]):not(.fancybox-focus-guard)", "iframe", "object", "embed", "video", "audio", "[contenteditable]", '[tabindex]:not([tabindex^="-"]):not([disabled]):not([aria-hidden])'].join(","),
        c = t => {
            if (t && a) {
                void 0 === r && document.createElement("div").focus({
                    get preventScroll() {
                        return r = !0, !1
                    }
                });
    ...
    class w extends v {
        ...
        onClose() {
            if (this.timer && clearTimeout(this.timer), !0 !== w.hasSilentClose) try {
    ...
    function x() {
        window.addEventListener("hashchange", y, !1), setTimeout((() => {
            w.startFromUrl()
        }), 500)
    }
    ...
    class A {
        constructor(t, {
            ...
            this.element.addEventListener("mousedown", this.onPointerStart, O), this.element.addEventListener("touchstart", this.onTouchStart, O), this.element.addEventListener("touchmove", this.onMove, O), this.element.addEventListener("touchend", this.onTouchEnd), this.element.addEventListener("touchcancel", this.onTouchEnd)
        }
        onPointerStart(t) {
        ...
        onPointerEnd(t) {
            t.buttons > 0 && 0 !== t.button || (this.triggerPointerEnd(t, new T(t)), window.removeEventListener("mousemove", this.onMove), window.removeEventListener("mouseup", this.onPointerEnd), window.removeEventListener("blur", this.onWindowBlur))
        }
        onTouchEnd(t) {
    ...
    class Y extends b {
        ...
        constructor(t, e = {}, i = {}) {
            ...
            if (this.container = t, this.initContent(), this.attachPlugins(Object.assign(Object.assign({}, Y.Plugins), i)), this.emit("init"), this.isContentLoading) {
        ...
        initContent() {
            ...
            if (i || (i = t.querySelector("img") || t.firstElementChild, i && F(i, e)), !i) throw new Error("No content found");
            this.content = i
        }
        onLoad() {
            this.spinner && (this.spinner.remove(), this.spinner = null), this.option("spinner") && this.container.classList.remove(this.cn("isLoading")), this.emit("afterLoad"), this.state === R.Init && this.enable()
        }
        onError() {
        ...
        detachEvents() {
            ...
            e.removeEventListener("click", this.onClick, {
                ...
                passive: !1
            }), null === (t = this.pointerTracker) || void 0 === t || t.stop(), this.pointerTracker = null, document.removeEventListener(_, this.onMouseMove), document.removeEventListener("keydown", this.onKeydown, !0), this.clickTimer && (clearTimeout(this.clickTimer), this.clickTimer = null), this.updateTimer && (clearTimeout(this.updateTimer), this.updateTimer = null)
        }
        animate() {
            this.setTargetForce();
            const t = this.option("maxVelocity");
            for (const e of k) this.friction ? (this.velocity[e] *= 1 - this.friction, t && !this.isScaling && (this.velocity[e] = Math.max(Math.min(this.velocity[e], t), -1 * t)), this.current[e] += this.velocity[e]) : this.current[e] = this.target[e];
        ...
        onClick(t) {
            ...
            if ((Math.abs(this.dragOffset.x) > 3 || Math.abs(this.dragOffset.y) > 3) && Date.now() - this.dragStart.time < 300) return t.preventDefault(), void t.stopPropagation();
        ...
        onPointerDown(t, e, i) {
            ...
            return "mousedown" === t.type && t.preventDefault(), E(this.targetScale, 1e3) === E(this.minScale, 1e3) ? (this.stop(), this.target.e = this.current.e, this.target.f = this.current.f) : this.stop("target"), this.isDragging = !0, this.addTrackingPoint(e), this.emit("touchStart", t), !0
        }
        onPointerMove(t, e, i) {
            ...
            this.option("rubberband") ? ("x" !== this.isInfinite && (f.xDiff > 0 && d < 0 || f.xDiff < 0 && d > 0) && (d *= Math.max(0, .5 - Math.abs(.75 / this.contentRect.fitWidth * f.xDiff))), "y" !== this.isInfinite && (f.yDiff > 0 && u < 0 || f.yDiff < 0 && u > 0) && (u *= Math.max(0, .5 - Math.abs(.75 / this.contentRect.fitHeight * f.yDiff)))) : (f.xDiff && (d = 0), f.yDiff && (u = 0));
            const m = this.targetScale,
                g = this.minScale,
                b = this.maxScale;
            m < .5 * g && (h = Math.max(h, g)), m > 1.5 * b && (h = Math.min(h, b)), "y" === this.lockedAxis && E(m) === E(g) && (d = 0), "x" === this.lockedAxis && E(m) === E(g) && (u = 0), this.applyChange({
                originX: a,
                originY: r,
                panX: d,
                panY: u,
        ...
        onPointerUp(t, e, i) {
            ...
            this.container.classList.remove(this.cn("isDragging")), this.isDragging && (this.addTrackingPoint(e), this.panOnlyZoomed && this.contentRect.width - this.contentRect.fitWidth < 1 && this.contentRect.height - this.contentRect.fitHeight < 1 && (this.trackingPoints = []), P(t.target, this.content) && "y" === this.lockedAxis && (this.trackingPoints = []), this.emit("touchEnd", t), this.isDragging = !1, this.lockedAxis = !1, this.state !== R.Destroy && (t.defaultPrevented || this.startDecelAnim()))
        }
        startDecelAnim() {
            this.rAF && (cancelAnimationFrame(this.rAF), this.rAF = null), this.isBouncingX = !1, this.isBouncingY = !1;
            for (const t of k) this.velocity[t] = 0, this.target[t] = this.current[t];
            ...
            l && (a = l / (1 / (1 - h) - 1)), c && (r = c / (1 / (1 - h) - 1)), ("y" === this.option("lockAxis") || "xy" === this.option("lockAxis") && "y" === this.lockedAxis && E(d) === this.minScale) && (a = l = 0), ("x" === this.option("lockAxis") || "xy" === this.option("lockAxis") && "x" === this.lockedAxis && E(d) === this.minScale) && (r = c = 0);
            const u = this.dragOffset.x,
                p = this.dragOffset.y,
                f = this.option("dragMinThreshold") || 0;
            Math.abs(u) < f && Math.abs(p) < f && (a = r = 0, l = c = 0), this.applyChange({
                panX: a,
                panY: r,
                friction: h
        ...
        onWheel(t) {
            ...
            var i = [t.deltaX, t.deltaY, t.detail].reduce((function(t, e) {
            ...
            const n = Math.max(-1, Math.min(1, i)),
                ...
                o = this.pwt,
                a = this.pwd;
            if (o && s - o < (e ? 300 : 150) && (e && a === n || !e && a !== n)) return void t.preventDefault();
            if (this.pwd = n, this.pwt = s, this.emit("wheel", t, n), this.panMode === _) return;
            if (t.defaultPrevented) return;
            const r = this.option("wheel");
            "pan" === r ? (t.preventDefault(), this.panOnlyZoomed && !this.canZoomOut() || this.applyChange({
                panY: 100 * n,
                bounce: !1
            })) : "zoom" === r && !1 !== this.option("zoom") && this.zoomWithWheel(t)
        }
        onMouseMove(t) {
            this.panWithMouse(t)
        }
        ...
        setTransform() {
            ...
            const {
                ...
                content: i,
                contentRect: n
            } = this, s = Object.assign({}, j);
            for (const i of k) {
                const n = "e" == i || "f" === i ? B : H;
                s[i] = E(t[i], n), Math.abs(e[i] - t[i]) < ("e" == i || "f" === i ? .51 : .001) && (this.current[i] = e[i])
            }
            const {
                a: o,
                b: a,
        ...
        updateMetrics(t = !1) {
            ...
            const f = (this.option("transformParent") ? n.parentElement : null) || n,
                m = f.getAttribute("style") || "";
            f.style.setProperty("transform", "none", "important"), n instanceof HTMLImageElement && (f.style.width = "", f.style.height = ""), f.offsetHeight;
            ...
            if (n instanceof HTMLImageElement && ({
                    ...
                    top: g.top - a.top + y,
                    bottom: a.bottom - g.bottom + y,
                    left: g.left - a.left + w,
                    right: a.right - g.right + w,
                    fitWidth: b,
                    fitHeight: v,
                    width: b,
                    height: v,
                    fullWidth: u,
                    fullHeight: p
                }), f.style.cssText = m, n instanceof HTMLImageElement && (f.style.width = `${b}px`, f.style.height = `${v}px`), this.setTransform(), !0 !== t) {
                let t = "";
        ...
        getBounds() {
            ...
            if (!0 === r || this.lockedAxis && r === this.lockedAxis) n = -1 / 0, o = 1 / 0, s = -1 / 0, a = 1 / 0;
                ...
                let {
                    containerRect: t,
                    contentRect: r
                } = this, l = E(this.contentRect.fitWidth * this.targetScale, B), c = E(this.contentRect.fitHeight * this.targetScale, B), {
                    innerWidth: h,
                    innerHeight: d
                } = t;
        ...
        updateControls() {
            ...
            let c = {
                    toggleMax: o - l < .5 * (r - l) ? r : l,
                    toggleCover: o - l < .5 * (a - l) ? a : l,
                    toggleZoom: o - l < .5 * (s - l) ? s : l
                } [t.option("click") || ""] || l,
                h = t.canZoomIn(),
                d = t.canZoomOut(),
                u = d && i === N;
            ...
            let p = h && E(c) > E(o),
                f = !p && !u && d && E(c) < E(o);
            C(e, this.cn("canZoomIn"), p), C(e, this.cn("canZoomOut"), f), C(e, this.cn("isDraggable"), u);
        ...
        applyChange({
            ...
            const d = this.state;
            if (d === R.Init || d === R.Destroy) return;
            this.rAF && (cancelAnimationFrame(this.rAF), this.rAF = null), this.isBouncingX = !1, this.isBouncingY = !1;
            ...
            let g = (new DOMMatrix).translate(p, f).translate(s, o).translate(t, e);
            if (this.option("zoom")) {
                if (!c) {
            ...
            for (const t of k) "a" != t && "d" != t || !(g[t] > this.minScale + 1e-5 || g[t] < this.minScale - 1e-5) ? this.target[t] = E(g[t], B) : this.target[t] = g[t];
            (this.targetScale < this.scale || Math.abs(i - 1) > .1 || this.panMode === _ || !1 === h) && !c && this.clampTargetBounds(), this.isResting || (this.state = R.Panning, this.requestTick())
        }
        stop(t = !1) {
        ...
        requestTick() {
            this.isTicking || (this.emit("startAnimation"), this.updateControls(), F(this.container, "is-animating"), this.isScaling && F(this.container, "is-scaling")), this.isTicking = !0, this.rAF || (this.rAF = requestAnimationFrame((() => this.animate())))
        }
        panWithMouse(t, e = this.option("mouseMoveFriction")) {
            if (this.prevMouseMoveEvent = t, this.panMode !== _ || !t) return;
        ...
        zoomWithWheel(t) {
            ...
            const e = Math.abs(t.deltaY) < 100 && Math.abs(t.deltaX) < 100 ? 75 : 50,
        ...
        zoomTo(t = 1, {
            ...
            let a = 1;
            if (this.panMode === _ && (s = this.prevMouseMoveEvent || s), s) {
        ...
        reset(t) {
            if (this.state !== R.Init && this.state !== R.Destroy) {
                ...
                this.target.a = this.minScale, this.target.d = this.minScale, this.isResting || (this.friction = void 0 === t ? this.option("friction") : t, this.state = R.Panning, this.requestTick())
            }
        }
        destroy() {
    ...
    class Z extends v {
        onCreateSlide(t, e, i) {
            ...
            o && "image" === a && "string" == typeof s && this.setContent(i, s).then((t => {
                ...
                if (e && s && o && n.isOpeningSlide(i) && this.getZoomInfo(i)) {
                    ...
                    F(t, "fancybox-ghost"), e.appendChild(t), t.src = o, setTimeout((() => {
                        n.animate(t, "f-fadeFastOut", (() => {
                            t && (t.remove(), t = null)
                        }))
                    }), 333), q(o).then((() => {
                        i.state = f.Opening, this.instance.emit("reveal", i), this.zoomIn(i).then((() => {
        ...
        onClose() {
            ...
            if (!r) return;
            this.instance.state = p.CustomClosing, n.classList.remove("is-zooming-in"), n.classList.add("is-zooming-out"), s.style.backgroundImage = `url('${a}')`, q(a).then((() => {
        ...
        setContent(t, e) {
            return new Promise(((n, s) => {
                ...
                if (c.classList.add("fancybox-image"), c.src = e || "", c.alt = (null === (o = t.caption) || void 0 === o ? void 0 : o.replace(/<[^>]+>/gi, "").substring(0, 1e3)) || `Image ${t.index+1} of ${null===(a=r.carousel)||void 0===a?void 0:a.pages.length}`, c.draggable = !1, t.srcset && c.setAttribute("srcset", t.srcset), t.sizes && c.setAttribute("sizes", t.sizes), t.imageEl = c, r.setContent(t, c, !1), this.option("protected")) {
                ...
                t.panzoom = new Y(l, i({}, this.option("Panzoom") || {}, {
                    content: c,
        ...
        zoomIn(t) {
            return new Promise(((e, i) => {
                ...
                const {
                    ...
                    t.state !== f.Closing && (h && (s.style.opacity = Math.max(Math.min(1, 1 - (1 - n.scale) / (1 - c)), 0) + ""), n.scale >= 1 && n.scale > n.targetScale - .1 && e(n))
                }, u = t => {
                    t.scale < .99 || t.scale > 1.01 || (s.style.opacity = "", o.classList.remove("is-zooming-in"), t.off("endAnimation", u), t.off("touchStart", u), t.off("afterTransform", d), e(t))
                };
                n.on("endAnimation", u), n.on("touchStart", u), n.on("afterTransform", d), n.on(["error", "destroy"], (() => {
                    i()
                })), n.panTo({
                    x: r,
                    y: l,
                ...
                const p = this.instance,
                    m = {
                        event: "mousemove" === n.panMode ? p.prevMouseMoveEvent || p.options.event : void 0
                    },
                    g = this.optionFor(t, "initialSize");
                F(o, "is-zooming-in"), p.hideLoading(t), "full" === g ? n.zoomToFull(m) : "cover" === g ? n.zoomToCover(m) : "max" === g ? n.zoomToMax(m) : n.reset(.165)
            }))
        }
        getZoomInfo(t) {
            const {
            ...
            h += g.top, d += g.left;
            const b = -1 * (d + .5 * u - (r + .5 * l)),
                v = -1 * (h + .5 * f - (a + .5 * c));
            let y = this.option("zoomOpacity") || !1;
            return "auto" === y && (y = Math.abs(l / c - u / f) > .1), {
                x: b,
                y: v,
                scale: m,
                opacity: y
    ...
    class J extends v {
        ...
        stop() {
            const t = this.instance.container;
            this.clear(), this.state = "ready", t.removeEventListener("mouseenter", this.onMouseEnter, !1), t.removeEventListener("mouseleave", this.onMouseLeave, !1), document.removeEventListener("visibilitychange", this.onVisibilityChange, !1), D(t, "has-autoplay"), this.emit("stop")
        }
        pause() {
        ...
        onPrepare(t) {
            ...
            n && (e.options.Autoplay = i(this.option("Autoplay") || {}, {
                ...
                on: {
                    ...
                    resume: (e, i) => {
                        var n, s, o;
                        !i || !i.cancelable || (null === (n = t.getSlide()) || void 0 === n ? void 0 : n.state) === f.Ready && (null === (o = null === (s = t.carousel) || void 0 === s ? void 0 : s.panzoom) || void 0 === o ? void 0 : o.isResting) || i.preventDefault()
                    }
                }
            }), e.attachPlugins({
                Autoplay: J
    ...
    let it = class extends v {
        ...
        onTransformM() {
            ...
            C(e, this.cn("isResting"), n.state !== R.Init && n.isResting);
            ...
            for (const e of t.slides) {
                let i = e.index,
                    n = e.thumbSlideEl;
                if (!n) continue;
                C(n, this.cn("isSelected"), i === t.page), l = 1 - Math.abs(t.getProgress(i)), n.style.setProperty("--progress", l ? l + "" : "");
                const h = .5 * ((e.thumbWidth || 0) - a);
        ...
        build() {
            ...
            F(a, this.cn("track")), s.appendChild(a), this.track = a, "classic" === n ? this.buildClassic() : this.buildModern(), this.state = et.Ready, s.addEventListener("click", (e => {
                setTimeout((() => {
                    var e;
        ...
        cleanup() {
            this.carousel && this.carousel.destroy(), this.carousel = null, this.panzoom && this.panzoom.destroy(), this.panzoom = null, this.container && this.container.remove(), this.container = null, this.track = null, this.state = et.Init, D(this.instance.container, this.cn("hasThumbs"))
        }
        attach() {
    ...
    const nt = Object.assign(Object.assign({}, tt), {
        key: "t",
        showOnStart: !0,
        parentEl: null
    });
    class st extends v {
        ...
        onInit() {
            ...
            n && (e.options.Thumbs = i({}, this.options, {
                ...
                Thumbs: it
            }), this.ref = e.plugins.Thumbs, this.option("showOnStart") || (this.ref.state = et.Hidden, this.hidden = !0))
        }
        onResize() {
            var t;
    ...
    class ct extends v {
        ...
        createContainer() {
            ...
            return F(i, "fancybox__toolbar"), e.prepend(i), i.addEventListener("click", this.onClick, {
                passive: !1,
                capture: !0
            }), t && F(t, "has-toolbar"), this.container = i, i
        }
        createEl(t) {
            var e;
            ...
            if (void 0 !== ot[t]) {
                const e = ot[t];
                s = document.createElement("button"), s.setAttribute("title", this.instance.localize(`{{${t.toUpperCase()}}}`)), F(s, "f-button"), e.action && (s.dataset.panzoomAction = e.action), e.change && (s.dataset.panzoomChange = JSON.stringify(e.change)), s.appendChild(n(this.instance.localize(e.icon)))
            } else {
            ...
            if (l)
                for (const [t, e] of Object.entries(lt)) l.getAttribute(t) || l.setAttribute(t, String(e));
            return s
        }
        removeContainer() {
            var t;
            ...
            e && e.removeEventListener("click", this.onClick, {
                passive: !1,
                capture: !0
            }), null === (t = this.container) || void 0 === t || t.remove(), this.container = null, this.state = at.Disabled;
    ...
    class vt extends v {
        ...
        refresh() {
            ...
            a && this.cleanup();
            const r = this.build();
            if (C(r, this.cn("isDynamic"), !!o), a)
                for (let t = 0; t < e; t++) r.append(this.createItem(t));
            let l, c = 0;
            for (const e of [...r.children]) {
                const i = c === this.instance.page;
                i && (l = e), C(e, this.cn("isCurrent"), i), null === (t = e.children[0]) || void 0 === t || t.setAttribute("aria-selected", i ? "true" : "false");
    ...
    class yt extends v {
        ...
        createButton(t) {
            ...
            i.setAttribute("tabindex", "0"), i.setAttribute("title", e.localize(`{{${t.toUpperCase()}}}`)), F(i, this.cn("button") + " " + this.cn("next" === t ? "isNext" : "isPrev"));
        ...
        build() {
            ...
            t || (this.container = t = document.createElement("div"), F(t, this.cn("container")), this.instance.container.appendChild(t)), this.next || (this.next = t.appendChild(this.createButton("next"))), this.prev || (this.prev = t.appendChild(this.createButton("prev")))
        }
        cleanup() {
    ...
    class wt extends v {
        ...
        markSelectedSlide(t) {
            ...
            e && e.state === ft.Ready && (this.selectedIndex = t, [...e.slides].map((e => {
    ...
    class Et extends b {
        ...
        constructor(t, e = {}, i = {}) {
            ...
            this.container = t, this.slideNext = dt(this.slideNext.bind(this), 150), this.slidePrev = dt(this.slidePrev.bind(this), 150), this.userOptions = e, this.userPlugins = i, queueMicrotask((() => {
                this.processOptions()
            }))
        }
        processOptions() {
            ...
            n === this.bp && this.state !== ft.Init || (this.bp = n, this.state === ft.Ready && (t.initialSlide = this.pages[this.page].slides[0].index), this.state !== ft.Init && this.destroy(), super.setOptions(t), !1 === this.option("enabled") ? this.attachEvents() : setTimeout((() => {
                this.init()
            }), 0))
        }
        init() {
            this.state = ft.Init, this.emit("init"), this.attachPlugins(Object.assign(Object.assign({}, Et.Plugins), this.userPlugins)), this.initLayout(), this.initSlides(), this.updateMetrics(), this.setInitialPosition(), this.initPanzoom(), this.attachEvents(), this.state = ft.Ready, this.emit("ready")
        }
        initLayout() {
            const {
                container: t
            } = this, e = this.option("classes");
            F(t, this.cn("container")), C(t, e.isLTR, !this.isRTL), C(t, e.isRTL, this.isRTL), C(t, e.isVertical, !this.isHorizontal), C(t, e.isHorizontal, this.isHorizontal);
            let i = this.option("viewport") || t.querySelector(`.${e.viewport}`);
            i || (i = document.createElement("div"), F(i, e.viewport), i.append(...ut(t, `.${e.slide}`)), t.prepend(i));
            let n = this.option("track") || t.querySelector(`.${e.track}`);
            n || (n = document.createElement("div"), F(n, e.track), n.append(...Array.from(i.childNodes))), n.setAttribute("aria-live", "polite"), i.contains(n) || i.prepend(n), this.viewport = i, this.track = n, this.emit("initLayout")
        }
        initSlides() {
            const {
                track: t
            ...
            if (t) {
                this.slides = [], [...ut(t, `.${this.cn("slide")}`)].forEach((t => {
                    if (s(t)) {
                        const e = mt({
                            el: t,
                            isDom: !0,
        ...
        initPanzoom() {
            ...
            this.panzoom = new Y(this.viewport, i({}, {
                content: this.track,
                zoom: !1,
                panOnlyZoomed: !1,
        ...
        createPages() {
            ...
            if ("number" == typeof n && e > i) {
                for (let e = 0; e < this.slides.length; e += n) t.push(gt({
                    index: e,
        ...
        processPages() {
            ...
            if (t.forEach(((t, s) => {
                    ...
                    s && !this.isInfinite && e > i && (t.pos = Math.max(t.pos, 0), t.pos = Math.min(t.pos, e - i)), t.pos = E(t.pos, 1e3), t.dim = E(t.dim, 1e3), t.pos < .1 && t.pos > -.1 && (t.pos = 0)
        ...
        getSlideMetrics(t) {
            ...
            let i = 0,
                n = 0,
                s = t.el;
            s ? i = parseFloat(s.dataset[e] || "") || 0 : (s = document.createElement("div"), s.style.visibility = "hidden", F(s, this.cn("slide") + " " + t.class), (this.track || document.body).prepend(s)), i ? (s.style[e] = `${i}px`, s.style["width" === e ? "height" : "width"] = "") : i = s.getBoundingClientRect()[e];
        ...
        repositionSlides() {
            ...
            for (const t of this.slides) t.el ? ("top" === s ? (t.el.style.right = "", t.el.style.left = "") : t.el.style.top = "", t.index !== o ? t.el.style[s] = 0 === a ? "" : `${E(a,1e3)}px` : t.el.style[s] = "", r += t.dim + t.gap, o++) : a += t.dim + t.gap;
            if (this.isInfinite && r)
                for (const i of this.slides) i.el && (E(i.pos) < E(t) && E(i.pos + i.dim + i.gap) < E(l) && E(l) > E(e - t) && (i.el.style[s] = `${E(a+r,1e3)}px`), E(i.pos + i.gap) >= E(e - t) && E(i.pos) > E(l + t) && E(l) < E(t) && (i.el.style[s] = `-${E(r,1e3)}px`));
            let c, h, d = [...this.inTransition];
            if (d.length > 1 && (c = this.pages[d[0]], h = this.pages[d[1]]), c && h) {
                let t = 0;
                for (const e of this.slides) e.el ? this.inTransition.has(e.index) && c.slides.indexOf(e) < 0 && (e.el.style[s] = `${E(t+(c.pos-h.pos),1e3)}px`) : t += e.dim + e.gap
            }
        }
        createSlideEl(t) {
        ...
        markSelectedSlides() {
            ...
            if (e)
                for (const i of this.slides) i.el && (i.el.dataset.index = `${i.index}`, this.pages[this.page].slides.includes(i) ? (i.el.classList.contains(e) || (F(i.el, e), this.emit("selectSlide", i)), i.el.removeAttribute(t)) : (i.el.classList.contains(e) && (D(i.el, e), this.emit("unselectSlide", i)), i.el.setAttribute(t, "true")))
        }
        flipInfiniteTrack() {
        ...
        lazyLoadSlide(t) {
            ...
            i.querySelectorAll("[data-lazy-srcset]").forEach((t => {
                ...
                t instanceof HTMLImageElement ? o.add(t) : s(t) && (t.style.backgroundImage = `url('${t.dataset.lazySrc||""}')`)
            }));
            const r = (t, i, n) => {
                n && (n.remove(), n = null), i.complete && (i.classList.add(a), setTimeout((() => {
            ...
            for (const e of o) {
                ...
                e.src = e.dataset.lazySrcset || e.dataset.lazySrc || "", delete e.dataset.lazySrc, delete e.dataset.lazySrcset, e.style.display = "none", e.addEventListener("error", (() => {
                    ...
                    e.parentNode && t.el && (e.complete ? r(t, e, i) : (i = n(h), e.parentNode.insertBefore(i, e)))
                }), 300)
            }
            let l = i.dataset.lazySrc;
            l && l.length && (i.style.backgroundImage = `url('${l}')`)
        }
        onAnimationEnd(t) {
            var e;
            const i = t.target,
        ...
        onDecel(t, e = 0, i = 0, n = 0, s = 0) {
            ...
            d ? this.onChange(f) : (Math.abs(h) > 5 ? ((this.pages.length < 3 || Math.max(Math.abs(n), Math.abs(s)) > this.pages[u].slides[0].dim) && (u = g), u = o && a ? h < 0 ? u - 1 : u + 1 : h < 0 ? u + 1 : u - 1) : u = g, this.slideTo(u, {
                transition: !1,
        ...
        onClick(t) {
            ...
            let n, o;
            i && (void 0 !== i.carouselPage ? (o = "slideTo", n = i.carouselPage) : void 0 !== i.carouselNext ? o = "slideNext" : void 0 !== i.carouselPrev && (o = "slidePrev")), o ? (t.preventDefault(), t.stopPropagation(), e && !e.hasAttribute("disabled") && this[o](n)) : this.emit("click", t)
        }
        onSlideTo(t) {
            const e = t.detail || 0;
        ...
        updateMetrics() {
            ...
            for (const [t, e] of this.slides.entries()) {
                ...
                !e.el && i ? (n = i.dim, o = i.gap) : (({
                    dim: n,
                    gap: o
                } = this.getSlideMetrics(e)), i = e), n = E(n, 1e3), o = E(o, 1e3), e.dim = n, e.gap = o, e.pos = s, s += n, (this.isInfinite || t < this.slides.length - 1) && (s += o)
            }
            this.viewport && (this.viewportDim = E(this.viewport.getBoundingClientRect()[e], 1e3));
    ...
    const St = "with-fancybox",
        Pt = "hide-scrollbar",
        Mt = "--fancybox-scrollbar-compensate",
        Ct = "--fancybox-body-margin",
        Tt = "is-animated",
        Ot = "is-compact",
        At = "is-loading";
    let zt = null,
    ...
    class It extends b {
        ...
        constructor(t = [], e = {}, i = {}) {
            ...
            })(), this.id = e.id || ++kt, Rt.set(this.id, this), this.userSlides = t, this.userPlugins = i, queueMicrotask((() => {
                this.init()
            }))
        }
        init() {
            this.state = p.Init, this.attachPlugins(Object.assign(Object.assign({}, It.Plugins), this.userPlugins)), this.emit("init"), !0 === this.option("hideScrollbar") && (() => {
                if (!a) return;
                ...
                document.documentElement.style.setProperty(Mt, `${e}px`), n && t.style.setProperty(Ct, `${n}px`), t.classList.add(Pt)
            })(), this.initLayout();
            const t = () => {
                this.initCarousel(this.userSlides), this.state = p.Ready, this.attachEvents(), this.emit("ready"), setTimeout((() => {
        ...
        initLayout() {
            ...
            e && (e.setAttribute("id", `fancybox-${this.id}`), e.setAttribute("aria-label", this.localize("{{MODAL}}")), e.classList.toggle(Ot, this.isCompact), F(e, this.option("mainClass") || ""), this.container = e, this.footer = e.querySelector(".fancybox__footer"), t.appendChild(e), F(document.documentElement, St), zt && Lt || (zt = document.createElement("span"), F(zt, "fancybox-focus-guard"), zt.setAttribute("tabindex", "0"), zt.setAttribute("aria-hidden", "true"), zt.setAttribute("aria-label", "Focus guard"), Lt = zt.cloneNode(), document.body.insertBefore(zt, e), document.body.append(Lt)), this.option("animated") && (F(e, Tt), setTimeout((() => {
        ...
        initCarousel(t) {
            ...
            if (!n) return;
            const s = this.carousel = new Et(n, i({}, {
                slides: t,
                transition: "fade",
                Panzoom: {
        ...
        onWheel(t) {
            const e = this.option("wheel", t),
                i = "slide" === e,
                n = [-t.deltaX, -t.deltaY, -t.detail].reduce((function(t, e) {
                    return Math.abs(e) > Math.abs(t) ? e : t
                })),
        ...
        manageCaption(t) {
            ...
            if (a) {
                if (c = t.captionEl || null, r && !c) {
                    ...
                    c = document.createElement("div"), c.className = "fancybox__caption", c.setAttribute("id", e), t.captionEl = r.appendChild(c), F(r, "has-caption"), r.setAttribute("aria-labelledby", e)
                }
            } else {
                ...
                F(s, "has-caption"), this.caption = c
            }
            c && (c.innerHTML = l)
        }
        checkFocus(t) {
        ...
        focus(t) {
            ...
            for (let t of r) {
                ...
                t === s || (i || n) && !e ? (h.push(t), void 0 !== t.dataset.origTabindex && (t.tabIndex = parseFloat(t.dataset.origTabindex)), t.removeAttribute("data-orig-tabindex"), !t.hasAttribute("autoFocus") && d || (d = t)) : (t.dataset.origTabindex = void 0 === t.dataset.origTabindex ? t.getAttribute("tabindex") || void 0 : t.dataset.origTabindex, t.tabIndex = -1)
            }
            let u = null;
            t ? (!n || h.indexOf(n) < 0) && (u = d || s, h.length && (i === Lt ? u = h[0] : this.lastFocus !== s && i !== zt || (u = h[h.length - 1]))) : u = o && "image" === o.type ? s : d || s, u && c(u), this.lastFocus = document.activeElement, this.ignoreFocusChange = !1
        }
        next() {
        ...
        setContent(t, e = "", i = !0) {
            ...
            if (!n) return;
            let o = null;
            if (s(e))["img", "iframe", "video", "audio"].includes(e.nodeName.toLowerCase()) ? (o = document.createElement("div"), o.appendChild(e)) : o = e;
            else {
                const t = document.createRange().createContextualFragment(e);
                o = document.createElement("div"), o.appendChild(t)
            }
            o instanceof Element && t.filter && !t.error && (o = o.querySelector(t.filter)), o instanceof Element ? (F(o, "fancybox__content"), t.id && o.setAttribute("id", t.id), "none" !== o.style.display && "none" !== getComputedStyle(o).getPropertyValue("display") || (o.style.display = t.display || this.option("defaultDisplay") || "flex"), n.classList.add(`has-${t.error?"error":t.type||"unknown"}`), n.prepend(o), t.contentEl = o, i && this.revealContent(t), this.manageCloseBtn(t), this.manageCaption(t)) : this.setError(t, "{{ELEMENT_NOT_FOUND}}")
        }
        revealContent(t, e) {
            const i = t.el,
                n = t.contentEl;
            i && n && (this.emit("reveal", t), this.hideLoading(t), t.state = f.Opening, (e = this.isOpeningSlide(t) ? void 0 === e ? this.optionFor(t, "showClass") : e : "f-fadeIn") ? this.animate(n, e, (() => {
                this.done(t)
            })) : this.done(t))
        }
        done(t) {
            this.isClosing() || (t.state = f.Ready, this.emit("done", t), F(t.el, "is-done"), this.isCurrentSlide(t) && this.option("autoFocus") && queueMicrotask((() => {
        ...
        showLoading(t) {
            ...
            const e = t.el;
            if (!e) return;
            F(e, At), this.emit("loading", t), t.spinnerEl || setTimeout((() => {
        ...
        hideLoading(t) {
            ...
            if (!e) return;
            const i = t.spinnerEl;
            this.isClosing() ? null == i || i.remove() : (D(e, At), i && this.animate(i, "f-fadeOut", (() => {
                i.remove()
        ...
        proceedClose(t, e) {
            ...
            if (r && (o(r) ? c(r) : r.focus()), n && (F(n, "is-closing"), n.setAttribute("aria-hidden", "true"), this.option("animated") && F(n, Tt), n.style.pointerEvents = "none"), s) {
            ...
            this.emit("close", t), this.state !== p.CustomClosing ? (void 0 === e && a && (e = this.optionFor(a, "hideClass")), e && a ? (this.animate(a.contentEl, e, (() => {
        ...
        destroy() {
            ...
            i ? i.focus() : (zt && (zt.remove(), zt = null), Lt && (Lt.remove(), Lt = null), D(document.documentElement, St), (() => {
                if (!a) return;
                const t = document,
                    e = t.body;
                e.classList.remove(Pt), e.style.setProperty(Ct, ""), t.documentElement.style.setProperty(Mt, "")
            })(), this.emit("destroy"))
        }
        static bind(t, e, i) {
            if (!a) return;
            let n, o = "",
                r = {};
            if (void 0 === t ? n = document.body : "string" == typeof t ? (n = document.body, o = t, "object" == typeof e && (r = e || {})) : (n = t, "string" == typeof e && (o = e), "object" == typeof i && (r = i || {})), !n || !s(n)) return;
            o = o || "[data-fancybox]";
        ...
        static fromEvent(t) {
            ...
            let s, o, a, r;
            if ([...It.openers].reverse().find((([t, i]) => !(!t.contains(e) || ![...i].reverse().find((([i, n]) => {
                    let l = e.closest(i);
        ...
        static getInstance(t) {
            ...
            return Array.from(Rt.values()).reverse().find((t => !t.isClosing() && t)) || null
        }
        static getSlide() {
            var t;
        ...
        static close(t = !0, ...e) {
            if (t)
                for (const t of Rt.values()) t.close(...e);
            else {
                const t = It.getInstance();
                t && t.close(...e)
            }
